...
#ifdef __SPECTRUM
typedef ProtoObjectProperty* ProtoObjectPropertyPtr;
#else
typedef ProtoObjectProperty* ProtoObjectPropertyPtr __attribute__((aligned(1)));
#endif
...
typedef struct
{
    ...
    ProtoObjectPropertyPtr properties[];
} ProtoObject;
...
/*
 * Get property pointer value by a given key. If no property has been found, NULL is returned.
